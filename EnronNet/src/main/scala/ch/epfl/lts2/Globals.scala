...
//  val MAY_01_END: Int = 359 + 365 + 366 + 159
  ...
  //4 JAN 1999 - 21 DEC 2002
    val DAYS_TOTAL: Int = 1448 // end date: 21 DEC 2002
    ...
    */
    // December
    val DEC_99_START: Int = 361 - 31 // 363 days in 1999 - 31 days of December
    val DEC_99_END: Int = 361 // 361 days in 1999

    // Mid-August 2001
    val AUG_01_START: Int = 361 + 366 + 213 // 364 in 1999 + 366 in 2000 + 213 in 2001
    val AUG_01_END: Int = 361 + 366 + 244

    // Late April 2001
    val APR_01_START: Int = 361 + 366 + 91
    val APR_01_END: Int = 361 + 366 + 121

    // End of May 2001 (It is said "before June 2001" in the paper, so add a few days of June as well (here, until 7 June))
    val MAY_01_START: Int = 361 + 366 + 122
    val MAY_01_END: Int = 361 + 366 + 159
}
